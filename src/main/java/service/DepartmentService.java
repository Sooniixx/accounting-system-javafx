...
public class DepartmentService {
    ...
    public void addDepartment(String name) {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            if (e.getMessage().contains("not found") || e.getMessage().contains("столбец")
                ...
                try (Connection conn = DatabaseManager.getConnection();
                    ...
                    throw new RuntimeException(
                            "Не вдалося додати новий відділ: " + name + " (SQL Error: " + ex.getMessage() + ")", ex);
                }
            }
            throw new RuntimeException("Не вдалося додати новий відділ: " + name + " (" + e.getMessage() + ")", e);
        }
    }
    ...
    public List<Department> getAllDepartments() {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            while (rs.next()) {
                ...
                // Передаємо третім параметром null, щоб задовольнити конструктор (int, String,
                // Integer)
